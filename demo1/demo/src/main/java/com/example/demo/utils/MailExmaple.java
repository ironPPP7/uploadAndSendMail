 ...
 * 使用IMAP协议接收邮件
 */
public class MailExmaple {

    public static final String USER = "";

    public static final String PASS = "";

    public static final String DIR = "F:\\mailtmp\\";
     ...
     * 接收邮件
     */
    public static void receive(Date begindate,Date enddate) throws Exception {
        ...
        IMAPStore imapStore = (IMAPStore) session.getStore(protocol); // 使用imap会话机制，连接服务器
        imapStore.connect(host, port, username, password);
        IMAPFolder imapFolder = (IMAPFolder) imapStore.getFolder("INBOX"); // 收件箱
        ...
        SearchTerm comparisonTermGe = new ReceivedDateTerm(ComparisonTerm.GT, DateUtil.getLast(20));
